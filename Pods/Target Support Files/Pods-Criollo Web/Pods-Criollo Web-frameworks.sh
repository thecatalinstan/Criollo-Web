...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CSFeedKit/CSFeedKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSOddFormatters/CSOddFormatters.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSSystemInfoHelper/CSSystemInfoHelper.framework"
